      ...
      >
        ...
        {isLoading && (
          <div className="flex gap-3 justify-start animate-pulse">
            ...
            <div className="max-w-[85%] p-3 rounded-lg border bg-white/[0.02] border-white/5 text-slate-500 italic">
      ...
      <div className="p-3 bg-black/20 border-t border-white/5">
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-[#0d0d12] border border-white/10 rounded-lg py-2.5 pl-4 pr-12 text-xs font-mono text-white placeholder-slate-600 focus:outline-none focus:border-f1-red transition-colors shadow-inner"
          />
          <button 
            onClick={handleSend}
